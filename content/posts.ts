...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: {
      ja: [
        ...
        '本記事では、辰巳協同組合がサポートする現場で実際にうまくいった「5つの工夫」を共有します。',
  ...
  },
  {
    ...
    body: {
      ja: [
        '4月の第二週、辰巳協同組合では春の合同オリエンテーションを開催しました。',
  ...
  },
  {
    ...
    body: {
      ja: [
        '愛知県の自動車部品メーカーA社様は、2021年から辰巳協同組合を通じて実習生を受け入れています。',
  ...
  },
  {
    ...
    body: {
      ja: [
        '辰巳協同組合では年に一度、受入をご検討中の企業様を現場にお招きするオープンハウスを開催しています。',
  ...
  },
  {
    ...
    body: {
      ja: [
        '辰巳協同組合は2026年1月、外国人技能実習機構 (OTIT) より監理団体許可の更新を受けました。',
